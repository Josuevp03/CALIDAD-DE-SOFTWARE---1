...
-- Roles y usuarios de demostración. Los valores de password_hash son hashes PBKDF2 de ejemplo.
...
(3, 'Diseñador', 'Paquetes y fabricación'),
(4, 'Supervisor de taller', 'Fabricación, inventario y control'),
...
INSERT OR IGNORE INTO tipo_evento (id_tipo_evento, nombre) VALUES
(1, 'Boda'), (2, 'Quinceañero'), (3, 'Graduación'), (4, 'Evento empresarial'),
(5, 'Bautizo'), (6, 'Fiesta patronal'), (7, 'Celebración tradicional'), (8, 'Otro');

INSERT OR IGNORE INTO evento (id_evento, id_cliente, id_tipo_evento, nombre, fecha, hora, lugar, ciudad, direccion, preferencias, observaciones) VALUES
(1, 1, 1, 'Boda María López', '2026-09-20', '18:00', 'Salón Colonial', 'La Paz', 'Av. Costanera 120', 'Tonos blancos y dorados', ''),
(2, 2, 2, 'Quinceañero Carlos Pérez', '2026-09-25', '19:30', 'Salón Imperial', 'Cochabamba', 'Av. Blanco Galindo 50', 'Decoración rosada', ''),
(3, 3, 4, 'Evento empresarial ABC', '2026-10-02', '09:00', 'Centro de Convenciones', 'Santa Cruz', 'Av. Las Palmas 400', 'Imagen corporativa azul', 'Montaje temprano');
...
INSERT OR IGNORE INTO paquete_decorativo (id_paquete, codigo, id_categoria, nombre, descripcion, precio_venta, precio_alquiler_periodo, color, material, tematica, capacidad) VALUES
...
INSERT OR IGNORE INTO artesano (id_artesano, id_usuario, nombre, especialidad) VALUES
(1, 5, 'Juan Quispe', 'Montaje de estructuras'), (2, NULL, 'María Condori', 'Decoración floral');
INSERT OR IGNORE INTO disenador (id_disenador, id_usuario, nombre, especialidad) VALUES
(1, 3, 'Laura Diseñadora', 'Diseño temático');
INSERT OR IGNORE INTO supervisor (id_supervisor, id_usuario, nombre) VALUES
(1, 4, 'Miguel Supervisor');

INSERT OR IGNORE INTO fabricacion (id_fabricacion, id_paquete, id_disenador, id_supervisor, fecha_inicio, fecha_fin, cantidad, eficiencia_equipo, estado, observaciones) VALUES
(1, 3, 1, 1, '2026-09-05', '2026-09-10', 4, 92, 'completada', 'Lote Rustic terminado'),
(2, 4, 1, 1, '2026-09-12', NULL, 3, 78, 'en_proceso', 'Revisión de estructura');
INSERT OR IGNORE INTO detalle_fabricacion (id_fabricacion, id_artesano, horas_trabajadas, actividad, estado) VALUES
(1, 1, 24, 'Armado de estructuras', 'completada'),
(1, 2, 18, 'Decoración floral', 'completada'),
(2, 1, 12, 'Montaje de paneles', 'en_proceso');

INSERT OR IGNORE INTO inventario (id_inventario, id_paquete, total, disponible, alquilado, vendido, reparacion) VALUES
(1, 1, 8, 6, 1, 1, 0),
(2, 2, 12, 9, 2, 1, 0),
(3, 3, 10, 7, 2, 0, 1),
(4, 4, 4, 2, 1, 0, 1);

INSERT OR IGNORE INTO venta (id_venta, id_cliente, fecha, subtotal, total, monto_pagado, estado) VALUES
(1, 1, '2026-09-12', 2100, 2100, 2100, 'confirmada'),
(2, 3, '2026-09-14', 7500, 7500, 3500, 'pendiente');
INSERT OR IGNORE INTO detalle_venta (id_venta, linea, id_paquete, cantidad, precio_unitario, subtotal) VALUES
(1, 1, 1, 1, 1800, 1800);

INSERT OR IGNORE INTO alquiler (id_alquiler, id_cliente, id_evento, fecha_inicio, fecha_devolucion_acordada, dias_solicitados, dias_cobrados, periodos, precio_por_periodo, total, pago_anticipado, estado) VALUES
(1, 1, 1, '2026-09-20', '2026-09-24', 4, 4, 2, 650, 1300, 1300, 'activo'),
(2, 2, 2, '2026-09-25', '2026-09-29', 4, 4, 2, 820, 1640, 820, 'pendiente');
INSERT OR IGNORE INTO detalle_alquiler (id_alquiler, linea, id_paquete, cantidad) VALUES
(1, 1, 1, 1),
(2, 1, 2, 2);

INSERT OR IGNORE INTO devolucion (id_devolucion, id_alquiler, fecha_real, estado_mobiliario, observaciones) VALUES
(1, 1, '2026-09-27', 'bueno', 'Entrega con 3 días de retraso');
INSERT OR IGNORE INTO mora (id_mora, id_devolucion, dias_retraso, periodos_mora, recargo) VALUES
(1, 1, 3, 2, 1300);

INSERT OR IGNORE INTO transporte (id_transporte, id_evento, id_alquiler, vehiculo, conductor, fecha_salida, estado) VALUES
(1, 1, 1, 'Camión 2', 'Pedro Rojas', '2026-09-20', 'programado'),
(2, 2, 2, 'Van 1', 'Lucía Méndez', '2026-09-25', 'programado');

INSERT OR IGNORE INTO servicio_adicional (id_servicio, nombre, tipo, precio, disponibilidad) VALUES
...
INSERT OR IGNORE INTO servicio_venta (id_venta, id_servicio, cantidad, precio_unitario) VALUES (1, 2, 1, 1200);
INSERT OR IGNORE INTO servicio_alquiler (id_alquiler, id_servicio, cantidad, precio_unitario) VALUES (1, 4, 1, 950), (1, 3, 1, 850);

INSERT OR IGNORE INTO montaje (id_montaje, id_alquiler, fecha_programada, responsable, estado) VALUES
(1, 1, '2026-09-20', 'Juan Quispe', 'completado');
INSERT OR IGNORE INTO desmontaje (id_desmontaje, id_alquiler, fecha_programada, responsable, estado) VALUES
(1, 1, '2026-09-27', 'María Condori', 'pendiente');
INSERT OR IGNORE INTO reparacion (id_reparacion, id_paquete, motivo, estado) VALUES
